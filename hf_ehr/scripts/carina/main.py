...
TOKENIZER_CHOICES: List[str] = [ 'clmbr', 'cookbook', 'desc', 'clmbr_8k', 'clmbr_16k', 'clmbr_64k', 'clmbr_96k', 'clmbr_118k','cookbook_32k' ]
DATALOADER_CHOICES: List[str] = [ 'approx', 'batch']
DATASET_CHOICES: List[str] = [ 'v8', 'v8-alltokens', 'v9', 'v9-alltokens', 'meds_dev', 'meds_mimiciv_demo', 'truven','meds_mimic4' ]
...
def parse_args():
    ...
    parser.add_argument("--partitions", default=None, help="Comma separated list of partitions. Defaults to `v100,gpu` for gpt2 and BERT, and `h100,a100` for HYENA and MAMBA.")
...
'''
--extra: default None
--partitions: default None; if not given, the script uses DEFAULT_PARTITIONS[args.model].
--is_force_refresh: default False
--is_skip_base: default False
--is_run_local: default False
'''
...
def main():
    ...
    # the command is run in the sbatch script.
    command = [
    ...
    print(f"The sbatch is { path_to_sbatch_script}")
